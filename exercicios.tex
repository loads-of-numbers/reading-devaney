...
\textbf{(8)} Sejam $\{\mathcal{C}_0,\ \mathcal{C}_1,\ \mathcal{C}_2,\ \cdots\}$ as etapas de construção de $\mathcal{C}$, o conjunto de Cantor canônico. \textcolor{red}{Finalizar e redigir.}
